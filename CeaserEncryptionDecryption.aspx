<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CeaserEncryptionDecryption.aspx.cs" Inherits="CeaserEncryptionDecryption" %>
             ...
             <table class="datashowCryptograph" style="width:57%;">
                 <tr>
                     <td class="newdata" colspan="2">
                         <asp:Label ID="Label1" runat="server" Text="Ceaser Cipher Encryption/Decryption"></asp:Label>
                     </td>
                 </tr>
                 <tr>
                     <td class="newdata" colspan="2">
                 ...
                 <tr>
                     <td class="auto-style6">
                         <asp:Button ID="ButtonEncrypt" class="navmenu" runat="server" Text="Encrypt" OnClick="ButtonEncrypt_Click" />
                     </td>
                     <td class="auto-style6">
                         <asp:Button ID="ButtonDecrypt" class="navmenu" runat="server" Text="Decrypt" OnClick="ButtonDecrypt_Click" />
                     </td>
                 </tr>
                 <tr>
                     <td class="newdata" colspan="2">
